...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2024 at 08:47 PM
...
CREATE TABLE `chat` (
  `id` int(11) NOT NULL,
  `from_me` varchar(255) DEFAULT NULL,
  `to_you` varchar(255) DEFAULT NULL,
...
INSERT INTO `chat` (`id`, `from_me`, `to_you`, `message`, `notifications`, `created_at`) VALUES
(1, NULL, NULL, NULL, NULL, '2024-10-19 19:00:29');
